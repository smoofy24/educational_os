...
nnoremap ,cc :ClaudeChat
nnoremap ,re :call SmoofyRemoteExplorer()
nnoremap ,eh :call SmoofyNerdtreeHelp()
nnoremap ,e :NERDTreeFind
nnoremap ,? :call SmoofyBuffersHelp()
nnoremap ,, 
nnoremap ,q :%bdelete|edit#
nnoremap ,/ :BLines
nnoremap ,h :History
nnoremap ,f :Files
nnoremap ,b :Buffers
...
nnoremap ,r :Rg
nnoremap ,g :GFiles
nnoremap ,ss :mksession! .session.vim
...
set runtimepath+=~/.vim/plugged/vim-yaml
set runtimepath+=~/.vim/plugged/claude.vim
set runtimepath+=/opt/homebrew/share/vim/vimfiles
set runtimepath+=/opt/homebrew/share/vim/vim91
set runtimepath+=/opt/homebrew/share/vim/vim91/pack/dist/opt/netrw
...
set runtimepath+=~/.vim/plugged/vim-yaml/after
...
silent only
silent tabonly
cd ~/Documents/Projects/O/OS/vilik
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess+=aoO
badd +1 kernel/include/drivers/uart.h
badd +1 kernel/src/drivers/uart.c
badd +0 Makefile
argglobal
%argdel
edit Makefile
...
exe 'vert 2resize ' . ((&columns * 169 + 121) / 242)
exe 'vert 3resize ' . ((&columns * 40 + 121) / 242)
argglobal
enew
file NERD_tree_tab_1
balt kernel/include/drivers/uart.h
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
balt kernel/src/drivers/uart.c
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
setlocal spelllang=en
setlocal spelloptions=
setlocal statusline=%#StatusLineNC#[Name]\ Makefile
setlocal suffixesadd=
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'tagbar'
